...
public class JpaRecipeIngredientEntity {
    ...
    public JpaRecipeIngredientEntity(UUID recipeId, UUID ingredientId, boolean isScalable, double baseQuantity) {
        this.id = new JpaRecipeIngredientId(recipeId, ingredientId);
    ...
    public static JpaRecipeIngredientEntity fromDomain(RecipeIngredient recipeIngredient, JpaRecipeEntity recipe) {
        JpaRecipeIngredientEntity jpaRecipeIngredient = new JpaRecipeIngredientEntity(
        ...
        jpaRecipeIngredient.recipe = recipe;
        return jpaRecipeIngredient;
    }
