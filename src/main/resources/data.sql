...
-- INGREDIENTS
-- ---------------------------------------------------------
INSERT INTO ingredients (ingredient_id, name, unit, category)
VALUES
    ('91b60a9d-be30-46e1-8499-ee668a4c2d7d', 'Spaghetti', 'GRAM', 'GRAIN'),
    ('df2e8703-4a38-45a7-a747-bb3f28afbf82', 'Pancetta', 'GRAM', 'MEAT'),
    ('1f821767-f0a9-4e03-ad70-c288f73efd9a', 'Eggs', 'PIECE', 'EGG'),
    ('046835e1-0e45-424f-9885-68b228b6f00b', 'Chicken breast', 'GRAM', 'POULTRY'),
    ('fca5db5d-f38f-4d59-96a2-7c06200748eb', 'Yogurt', 'GRAM', 'DAIRY'),
    ('ff1ac84b-ee97-40d2-9f38-ae919d48f9e8', 'Tomato sauce', 'GRAM', 'SAUCE_CONDIMENT'),
    ('fcc8d46c-780b-484c-bfe6-5b677805ca3c', 'Heavy cream', 'MILLILITER', 'DAIRY'),
    ('b89b2345-fc75-44c0-89b3-3e04d74124b4', 'Garam masala', 'TEASPOON', 'SPICE'),
    ('eade830d-1bc4-47de-8052-d1b91df42f1d', 'Ground beef', 'GRAM', 'MEAT'),
    ('3f03ff9b-31e5-4d48-a6a4-28d5fd81c898', 'Tortillas', 'PIECE', 'GRAIN'),
    ('3eddeece-5867-4416-824d-c627f2aa5979', 'Cheddar cheese', 'GRAM', 'DAIRY'),
    ('307f5492-e16a-431a-9cdb-75c9c6815a3f', 'Salsa', 'GRAM', 'SAUCE_CONDIMENT'),
    ('4b434f28-cef0-4d8b-82a3-01fbf534cf22', 'Sour cream', 'GRAM', 'DAIRY'),
    ('09b582cb-a0ea-4c18-bd4f-c814e66c50dd', 'Bell peppers', 'PIECE', 'VEGETABLE'),
    ('f6e83d4b-4d67-4044-9ee8-eedd8b347d4a', 'Broccoli', 'GRAM', 'VEGETABLE'),
    ('683a34ed-13d9-4c92-bf04-27e852716210', 'Carrots', 'PIECE', 'VEGETABLE'),
    ('69639b8d-d1e8-4cb7-879f-5a9bf362d87c', 'Soy sauce', 'TABLESPOON', 'SAUCE_CONDIMENT'),
    ('39d1ac57-8bf9-478e-ac53-3036a240610a', 'Sesame oil', 'TABLESPOON', 'OIL_FAT'),
    ('cb2e829b-fa70-4a66-a667-5473e3e8b723', 'Onions', 'PIECE', 'VEGETABLE'),
    ('cffb78b8-2cd4-4658-91ca-1da17e4f7a3a', 'Beef broth', 'LITER', 'SAUCE_CONDIMENT'),
    ('246de5df-8917-4530-8b91-06f7d7d32412', 'Gruyere cheese', 'GRAM', 'DAIRY'),
    ('6cd4fe2d-c2c0-4e1e-aa5a-ed773e116747', 'Baguette', 'PIECE', 'GRAIN'),
    ('1b194de6-4e86-4b46-b3a0-bebcbad0e15e', 'Butter', 'GRAM', 'DAIRY'),
    ('cc95f369-dda7-42d4-8035-bbaaacea963c', 'Bananas', 'PIECE', 'FRUIT'),
    ('b83a4fc3-e819-4edc-9f40-6841beaa3b80', 'Flour', 'GRAM', 'GRAIN'),
    ('48b21301-e07c-4118-92b9-f173336093ba', 'Milk', 'MILLILITER', 'DAIRY'),
    ('8ea17cd5-fea4-45f4-bfb6-35f0f04e583c', 'Tomatoes', 'PIECE', 'VEGETABLE'),
    ('1834b787-3ceb-49e2-9207-e3de61020049', 'Cucumber', 'PIECE', 'VEGETABLE'),
    ('4725715a-2570-4737-a62c-ac43cbd7ea90', 'Feta cheese', 'GRAM', 'DAIRY'),
    ('7cf382d1-b6c9-4424-93b8-59ad6e3c879e', 'Kalamata olives', 'GRAM', 'VEGETABLE'),
    ('a4378573-1d8d-44f5-80f6-22175b0c4f9c', 'Olive oil', 'TABLESPOON', 'OIL_FAT'),
    ('f63a1464-ce64-44e7-9088-046f044645e7', 'Beef chuck', 'GRAM', 'MEAT'),
    ('084ed9bf-48c4-42c7-afd1-ca63e6a95b0d', 'Red wine', 'MILLILITER', 'BEVERAGE'),
    ('5245895d-bffe-4af2-89eb-7ed5e729d394', 'Mushrooms', 'GRAM', 'FUNGI'),
    ('655c0e6e-a675-4a10-a0e7-55cde4ec19c6', 'Bacon', 'GRAM', 'MEAT'),
    ('332343ec-3fde-4ef0-ae83-97d42ab8f861', 'Pizza dough', 'GRAM', 'GRAIN'),
    ('373507a5-b659-4ca9-868c-8f39319946b2', 'Fresh mozzarella', 'GRAM', 'DAIRY'),
    ('6c81d1a3-66f7-42de-9ad1-05a5d748bcc8', 'Fresh basil', 'GRAM', 'HERB'),
    ('00885e1e-20a0-4c3d-aa23-ce1bd5ddc385', 'Dark chocolate', 'GRAM', 'SWEETENER'),
    ('78223711-7e76-4f37-99c1-6c80daa63f2e', 'Sugar', 'GRAM', 'SWEETENER');
