...
@RestController
@RequestMapping("/api/schedules/households/{householdId}")
public class HouseholdWeekScheduleController {

    private final WeekScheduleService scheduleService;

    public HouseholdWeekScheduleController(WeekScheduleService scheduleService) {
